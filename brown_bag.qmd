...
## [Come to our next event this Thursday!]{auto-animate="true"}{background-image="images/workflowr.jpeg" background-size="70%"}
...
- [Joint the Volunteer team: to help us with setting up successful events]{.rladies-purple}
